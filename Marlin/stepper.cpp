  ...
  if (current_block != NULL) {
    ...
    if ((out_bits & (1<<Z_AXIS)) != 0) {   // -direction
      ...
      CHECK_ENDSTOPS
      {
          ...
          bool z_min_endstop=(READ(Z_MIN_PIN) != Z_MIN_ENDSTOP_INVERTING) || (READ(Z_PROBE_MIN_PIN) != Z_PROBE_MIN_ENDSTOP_INVERTING);
...
void st_init()
{
  ...
  #if defined(Z_PROBE_MIN_PIN) && Z_PROBE_MIN_PIN > -1
    SET_INPUT(Z_PROBE_MIN_PIN);
  #endif
